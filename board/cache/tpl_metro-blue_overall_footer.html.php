...
<!-- Prefooter blocks go below --><?php $this->_tpl_include('prefooter_blocks.html'); ?>
...
<div id="page-footer">
	...
	<div class="copyright">
		<?php if ($this->_rootref['U_MCP']) {  ?><a class="mcp" href="<?php echo (isset($this->_rootref['U_MCP'])) ? $this->_rootref['U_MCP'] : ''; ?>"><?php echo ((isset($this->_rootref['L_MCP'])) ? $this->_rootref['L_MCP'] : ((isset($user->lang['MCP'])) ? $user->lang['MCP'] : '{ MCP }')); ?></a><?php if (! $this->_rootref['U_ACP']) {  ?><br /><br /><?php } } if ($this->_rootref['U_ACP']) {  if ($this->_rootref['U_MCP']) {  ?> | <?php } ?><a class="acp" href="<?php echo (isset($this->_rootref['U_ACP'])) ? $this->_rootref['U_ACP'] : ''; ?>"><?php echo ((isset($this->_rootref['L_ACP'])) ? $this->_rootref['L_ACP'] : ((isset($user->lang['ACP'])) ? $user->lang['ACP'] : '{ ACP }')); ?></a><br /><br /><?php } if ($this->_rootref['U_MCP']) {  echo (isset($this->_rootref['CURRENT_TIME'])) ? $this->_rootref['CURRENT_TIME'] : ''; ?><br /><br /><?php } else if ($this->_rootref['S_USER_LOGGED_IN']) {  echo (isset($this->_rootref['CURRENT_TIME'])) ? $this->_rootref['CURRENT_TIME'] : ''; ?><br /><br /><?php } ?>

        Copyright &copy; 2013 Enthst. All Posts &copy; Their Respective Owners<br />
		Handcrafted In Scotland, Powered By Phpbb &reg;
