...
<table class="tablebg" width="100%" cellspacing="1" style="table-layout: fixed;">
	<tr>
		<td class="cat"><a name="mChat"></a><?php if ($this->_rootref['MCHAT_ARCHIVE_MODE']) {  ?><h4><?php echo ((isset($this->_rootref['L_MCHAT_ARCHIVE_PAGE'])) ? $this->_rootref['L_MCHAT_ARCHIVE_PAGE'] : ((isset($user->lang['MCHAT_ARCHIVE_PAGE'])) ? $user->lang['MCHAT_ARCHIVE_PAGE'] : '{ MCHAT_ARCHIVE_PAGE }')); ?></h4><?php } else { ?><h4>Shoutbox</h4><?php } ?></td>
	</tr>
	<tr>
			...
			<?php if ($this->_rootref['MCHAT_STATIC_MESS']) {  ?><div class="mChatStatic"><strong><?php echo ((isset($this->_rootref['L_MCHAT_ANNOUNCEMENT'])) ? $this->_rootref['L_MCHAT_ANNOUNCEMENT'] : ((isset($user->lang['MCHAT_ANNOUNCEMENT'])) ? $user->lang['MCHAT_ANNOUNCEMENT'] : '{ MCHAT_ANNOUNCEMENT }')); ?>:</strong> <span style="color:#990000;"><?php echo (isset($this->_rootref['MCHAT_STATIC_MESS'])) ? $this->_rootref['MCHAT_STATIC_MESS'] : ''; ?></span></div><?php } if (! ( $this->_rootref['MCHAT_ARCHIVE_MODE'] || $this->_rootref['MCHAT_CUSTOM_PAGE'] ) && $this->_rootref['MCHAT_WHOIS'] && $this->_rootref['S_MCHAT_INDEX_STATS']) {  ?><div class="mChatStats" id="mChatStats"><?php if ($this->_rootref['MCHAT_USERS_LIST']) {  ?><a href="#" onclick="mChat.toggle('UserList'); return false;"><?php echo (isset($this->_rootref['MCHAT_USERS_COUNT'])) ? $this->_rootref['MCHAT_USERS_COUNT'] : ''; ?></a><?php } else { echo (isset($this->_rootref['MCHAT_USERS_COUNT'])) ? $this->_rootref['MCHAT_USERS_COUNT'] : ''; } ?>&nbsp;<?php echo ((isset($this->_rootref['L_MCHAT_ONLINE_EXPLAIN'])) ? $this->_rootref['L_MCHAT_ONLINE_EXPLAIN'] : ((isset($user->lang['MCHAT_ONLINE_EXPLAIN'])) ? $user->lang['MCHAT_ONLINE_EXPLAIN'] : '{ MCHAT_ONLINE_EXPLAIN }')); ?><br /><span id="mChatUserList"><?php echo (isset($this->_rootref['MCHAT_USERS_LIST'])) ? $this->_rootref['MCHAT_USERS_LIST'] : ''; ?></span></div><?php } ?>
				...
				<div class="mChatPanel">
					...
					<div style="padding: 3px;">
						...
						<img src="<?php echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>mchat/ok.gif" alt="<?php echo ((isset($this->_rootref['L_MCHAT_OK'])) ? $this->_rootref['L_MCHAT_OK'] : ((isset($user->lang['MCHAT_OK'])) ? $user->lang['MCHAT_OK'] : '{ MCHAT_OK }')); ?>" title="<?php echo ((isset($this->_rootref['L_MCHAT_OK'])) ? $this->_rootref['L_MCHAT_OK'] : ((isset($user->lang['MCHAT_OK'])) ? $user->lang['MCHAT_OK'] : '{ MCHAT_OK }')); ?>" id="mChatOkIMG" class="mChatImageOk" style="display:none;" />
						<img src="<?php echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>mchat/error.gif" alt="<?php echo ((isset($this->_rootref['L_MCHAT_ERROR'])) ? $this->_rootref['L_MCHAT_ERROR'] : ((isset($user->lang['MCHAT_ERROR'])) ? $user->lang['MCHAT_ERROR'] : '{ MCHAT_ERROR }')); ?>" title="<?php echo ((isset($this->_rootref['L_MCHAT_ERROR'])) ? $this->_rootref['L_MCHAT_ERROR'] : ((isset($user->lang['MCHAT_ERROR'])) ? $user->lang['MCHAT_ERROR'] : '{ MCHAT_ERROR }')); ?>" id="mChatErrorIMG" class="mChatImageHideImg" style="display:none;" />
					<img src="<?php echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>mchat/paused.gif" alt="<?php echo ((isset($this->_rootref['L_MCHAT_PAUSE'])) ? $this->_rootref['L_MCHAT_PAUSE'] : ((isset($user->lang['MCHAT_PAUSE'])) ? $user->lang['MCHAT_PAUSE'] : '{ MCHAT_PAUSE }')); ?>" title="<?php echo ((isset($this->_rootref['L_MCHAT_PAUSE'])) ? $this->_rootref['L_MCHAT_PAUSE'] : ((isset($user->lang['MCHAT_PAUSE'])) ? $user->lang['MCHAT_PAUSE'] : '{ MCHAT_PAUSE }')); ?>" id="mChatPauseIMG" class="mChatImageHideImg" style="display:none;" />
					<span id="mChatRefreshText"><?php echo (isset($this->_rootref['MCHAT_REFRESH_YES'])) ? $this->_rootref['MCHAT_REFRESH_YES'] : ''; ?></span><?php if ($this->_rootref['MCHAT_USER_TIMEOUT']) {  ?> &bull; <span id="mChatSessMess">&nbsp;</span><?php } ?> &bull; <?php echo ((isset($this->_rootref['L_MCHAT_USESOUND'])) ? $this->_rootref['L_MCHAT_USESOUND'] : ((isset($user->lang['MCHAT_USESOUND'])) ? $user->lang['MCHAT_USESOUND'] : '{ MCHAT_USESOUND }')); ?> <input type="checkbox" id="mChatUseSound" <?php if ($this->_rootref['S_MCHAT_SOUND_YES']) {  ?>checked="checked"<?php } ?> />
					</div>
				</div>
				</form>
			<?php } ?>
